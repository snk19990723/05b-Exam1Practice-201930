...
def run_test_problem1a():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    expected = -0.8752764642215926  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = -1.049612178305792  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([3, 69], expected, test_results,
                                  format_string)
    actual = problem1a(3, 69)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
